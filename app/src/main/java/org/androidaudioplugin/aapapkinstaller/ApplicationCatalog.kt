...
object ApplicationCatalog {
    ...
    fun setupApkList() {
        ...
        store.githubRepositories.addAll(listOf(
            ...
            GitHubRepositoryInformation("atsushieno", "uapmd",
                "dev.atsushieno.uapmd", "UAPMD"),
            ...
            GitHubRepositoryInformation("atsushieno", "aap-juce-wavetable",
                "org.androidaudioplugin.ports.juce.wavetable", "AAP Wavetable"),
